...
define('TINYIB_DEFAULTPASS', "");      // Default password for 'admin', the default user
...
define('TINYIB_RECAPTCHA', false);     // Reduce spam by requiring users to pass a reCAPTCHA when posting  (click Rebuild All in the management panel after enabling)
define('TINYIB_RECAPTCHAPUBLIC', "");  // reCAPTCHA site key (required if TINYIB_RECAPTCHA is true)
define('TINYIB_RECAPTCHAPRIVATE', ""); // reCAPTCHA secret key (required if TINYIB_RECAPTCHA is true)
...
define('TINYIB_DBUSERS', "users");     // Users table name (use the same users table across boards for global users)
